...
import styles from '@/app/(after-login)/_component/nav-menu.module.css'
          ...
          <div className={styles.navPill}>
            {segment === 'home' ? (
              <>
                ...
                <div className={styles.fontBold}>Home</div>
              </>
            ) : (
              <>
                <svg
          ...
          <div className={styles.navPill}>
            {segment && ['search', 'explore'].includes(segment) ? (
              <>
                ...
                <div className={styles.fontBold}>Search</div>
              </>
            ) : (
              <>
                <svg
          ...
          <div className={styles.navPill}>
            {segment === 'messages' ? (
              <>
                ...
                <div className={styles.fontBold}>Messages</div>
              </>
            ) : (
              <>
                <svg
            ...
            <div className={styles.navPill}>
              {segment === me?.user?.email ? (
                <>
                  ...
                  <div className={styles.fontBold}>Profile</div>
                </>
              ) : (
                <>
                  <svg
